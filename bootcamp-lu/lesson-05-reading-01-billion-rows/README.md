...
2. Definir a versão do Python: usando o Pyenv: `pyenv install 3.12.1` and `pyenv local 3.12.1`

2. `poetry env use 3.12.1` e `poetry install --no-root` e `poetry lock --no-update`
